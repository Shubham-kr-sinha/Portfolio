            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="grid md:grid-cols-2 gap-12">
                    ...
                    <div className="space-y-8 animate-fade-in-left">
                        <div>
                            <h3 className="text-2xl font-bold text-dark-100 mb-4">Let's Connect!</h3>
                        ...
                        <div className="space-y-4">
                            <a
                                ...
                                className="flex items-center gap-4 p-4 bg-dark-800 rounded-lg border border-dark-700 hover:border-primary-500 transition-all duration-300 group"
                            >
                                ...
                                <div>
                                    ...
                                    <p className="text-dark-100 font-medium">shubhamkrsinha11111@gmail.com</p>
                                </div>
                            </a>
                            ...
                            >
                                ...
                                <div>
                                    ...
                                    <p className="text-dark-100 font-medium">@Shubham-kr-sinha</p>
                                </div>
                            </a>
                            ...
                            >
                                ...
                                <div>
                                    ...
                                    <p className="text-dark-100 font-medium">Shubham Kumar Sinha</p>
                                </div>
                            </a>
                        </div>
                    </div>
                    ...
                    <div className="animate-fade-in-right">
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            {status && (
                                <p className="text-primary-400 text-center font-medium animate-fade-in">
                                    {status}
                                </p>
                            )}
                        </form>
